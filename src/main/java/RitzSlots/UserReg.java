...
public class UserReg {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        ChromeDriver driver = new ChromeDriver(options);
        		...
        		driver.get("https://rcdevonbo.digient.co/login");
               ...
               driver.get("https://rcdevonbo.digient.co/user_register");
               for(int i=1;i<=20;i++) {
            	   String randomPhoneNumber = generatePhoneNumber();
               driver.findElement(By.xpath("//*[@id = 'USERNAME']")).sendKeys("usdch"+i);        
               driver.findElement(By.xpath("//*[@id = 'EMAIL']")).sendKeys("usdch"+i+"@gmail.com");        

...
public class CricketbookUserReg {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        ChromeDriver driver = new ChromeDriver(options);
        		...
        		driver.get("https://devbo.cricketbook.com/login");
        		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        		driver.findElement(By.xpath("//*[@id = 'signinname']")).sendKeys("Xadmin");
               driver.findElement(By.xpath("//*[@id = 'signinpassword']")).sendKeys("Test@123");    
               Thread.sleep(5000);
               driver.findElement(By.xpath("//*[@id = 'login_button']")).click();
               driver.get("https://devbo.cricketbook.com/user_register");
               for(int i=51;i<=100;i++) {
            	   String randomPhoneNumber = generatePhoneNumber();
               driver.findElement(By.xpath("//*[@id = 'USERNAME']")).sendKeys("castest"+i);        
               driver.findElement(By.xpath("//*[@id = 'EMAIL']")).sendKeys("castest"+i+"@gmail.com");        
